...
class TestSSECCreateMultipartUploadHeaders:
    ...
    def test_sse_c_customer_key_decodes_to_short_value(
        ...
        """Test CreateMultipartUpload with customer key '####' that decodes to 0 bytes via lenient base64."""
        _, key_md5 = generate_sse_c_key()
    ...
    def test_sse_c_customer_key_zz(
        ...
        """Test CreateMultipartUpload with customer key 'ZZ' that decodes to 1 byte (0x65) via base64."""
        _, key_md5 = generate_sse_c_key()
    ...
    def test_sse_c_customer_key_single_char_a(
        ...
        """Test CreateMultipartUpload with customer key 'a' — invalid base64 (1 char, needs min 2 for a byte)."""
        _, key_md5 = generate_sse_c_key()
    ...
    def test_sse_c_customer_key_latin1_chars(
        ...
        """Test CreateMultipartUpload with customer key as latin-1 non-ASCII chars.
    ...
    def test_sse_c_empty_customer_key(
        ...
        """Test CreateMultipartUpload with empty string as customer key."""
        _, key_md5 = generate_sse_c_key()
    ...
    def test_sse_c_customer_key_with_garbage_chars_in_base64(
        ...
        """Test CreateMultipartUpload with valid 32-byte key base64 + garbage chars at various positions.
    ...
    def test_sse_c_customer_key_decodes_to_1_byte(
        ...
        """Test CreateMultipartUpload with customer key that decodes to 1 byte (AQ==)."""
        short_key = b"\x01"
        key_b64, key_md5 = generate_sse_c_key(short_key)
